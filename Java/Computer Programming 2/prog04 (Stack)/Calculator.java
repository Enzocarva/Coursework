...
public class Calculator {
  ...
  boolean previousTknNumOrRightParenthesis = false;
  ...
  void doNumber (double x) {
    numberStack.push(x);
    previousTknNumOrRightParenthesis = true;
    displayStacks();
  }
  ...
  void doOperator (char op) {
    ...
    if (op == '-' && numberStack.empty()) {
      previousTknNumOrRightParenthesis = false;
    }
    if ((op == '-') && (!previousTknNumOrRightParenthesis)) {
      op = 'u';
    } else {
      previousTknNumOrRightParenthesis = false;
    }
  ...
  void evaluateTopOperator () {
    if (operatorStack.peek() == 'u') {
     ...
     displayStacks();
      ...
      double c = evaluateOperator(b, op, a);
      numberStack.push(c);
      displayStacks();
    }
  }
